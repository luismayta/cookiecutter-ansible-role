...
Contributions to {{ cookiecutter.app_name }} are welcome.
...
.. _Issue: {{ cookiecutter.repository_domain }}/{{ cookiecutter.repository_owner }}/{{ cookiecutter.app_name }}/issues
.. _Pull Request: {{ cookiecutter.repository_domain }}/{{ cookiecutter.repository_owner }}/{{ cookiecutter.app_name }}/pulls
